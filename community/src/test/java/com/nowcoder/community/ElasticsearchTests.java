...
public class ElasticsearchTests {
    @Autowired
    private DiscussPostMapper discussMapper;    //从Mysql数据库中取出数据再存到Elasticsearch中去
    ...
    public void testSearchByRepository() {
        ...
        // discussRepository.search(searchQuery)方法底层获取得到了高亮显示的值, 但是没有返回.
        // 可以使用elasticTemplate.queryForPage(searchQuery, class, SearchResultMapper)对高亮和原始数据进行整合
